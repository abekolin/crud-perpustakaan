...
">
                            ...
                            <div class="row justify-content-start">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <select name="id_penulis" id="penulis" class="form-select" style="width:auto;">
                                    ...
                                    <div class="d-flex justify-content-start">
                                        <a href="insert_books.php" class="btn" style="color:white; background-color:#dc3545;">Reset</a>&nbsp;
    ...
    <a href="logout.php" class="btn btn-danger" style="margin-left:94%; position:absolute; margin-top: 20px; z-index:2; position:fixed;"> Logout</a>
