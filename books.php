...
$books = query("SELECT 
                        buku.id_buku as id, 
                        buku.judul, buku.genre, 
                        buku.tahun, buku.gambar, 
...
">
    ...
    z-index: 1; padding-bottom: 70px;">
        ...
        <div class="container mt-4 pb-4 pt-4" style="background-color:white;">
            <a href="insert_books.php" class="btn mb-3" style="background-color:#00BFFF; color:white;">
                <i class="fas fa-plus"></i> Tambah Data</a>
            <div class="card">
                <div class="card-body">
                    <h6 class="card-header">Tabel Buku</h6>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($books as $row) : ?>
                                    <tr>
                                        ...
                                        <td scope="row"><?= $i; ?></td>
                                        <td>
                                            <img src="img/<?= $row['gambar']; ?>" alt="Foto Buku" class="img-thumbnail" style="width: 100px; height:100px;">
                                        </td>
                                        ...
                                        <td>
                                            <a href="edit_books.php?id=<?= $row['id']; ?>" class="btn" style="background-color:#00BFFF;color:white;"><i class="bi bi-pencil-square"></i> Edit</a>
                                            <a href="hapus_books.php?id=<?= $row['id']; ?>" class="btn btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?');" style="padding:8px; background-color:#dc3545; color:white;"> <i class="bi bi-trash-fill"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
